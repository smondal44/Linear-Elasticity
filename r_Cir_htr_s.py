...
Linear elasticity problem for circular heterogeneous precipitate of radious 20nm in the domain of 400*400. 
...
eta0 = Expression(("sqrt(pow((x[0]-0),2)+pow((x[1]-0),2)) <= (r+tol1) ? 1 : 0.0065","0"),degree =0,L=L,H=H,r=r,tol1 = tol1)
